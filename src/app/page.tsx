    ...
    <div className="flex flex-col gap-20 pb-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              Upload your resume and get an instant ATS score, detailed skill gap
              analysis, and personalized feedback powered by Google Gemini AI.
            </p>
      ...
      <section className="bg-primary py-24 text-primary-foreground relative overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold font-headline mb-12">
            Landing a job at top tech companies has never been easier.
          </h2>
        ...
        <div className="bg-muted/50 rounded-[3rem] p-12 md:p-20 flex flex-col md:flex-row items-center gap-12 border border-border">
          <div className="flex-1">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Don't let a generic resume hold you back. Let ResumePilot AI
              optimize your profile for your dream role today.
            </p>
